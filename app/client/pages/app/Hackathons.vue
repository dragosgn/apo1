      ...
      <v-card pb-2>
        <v-card-text class="text-xs-center">
          ...
          <v-layout row class="body-2" justify-space-around align-center pt-3>
            ...
            >
              {{stat}}:
              <span v-if="!loading_stat">{{value}}</span>
              <v-progress-circular
                size="20"
                indeterminate
                width="3"
        ...
        <v-card-actions>
          <v-btn color="red" small block to="/app/planedhacks">future hackathons. Check hier.</v-btn>
        </v-card-actions>
      </v-card>
    </v-container>
        ...
        <v-timeline dense>
          ...
          >
            ...
            <template v-slot:icon>
              <span style="color:#ffa400;font-size: 12px;">{{hackathons.length-index}}</span>
            </template>
            ...
            >
              ...
              >
                <v-img v-if="hack.pics && hack.pics[0]" :src="hack.pics[0]" aspect-ratio="2.75"></v-img>
                <v-card-text>
                  <v-layout row>
                    <v-flex grow>
                      <h3>{{hack.titel}}</h3>
                      ...
                      <v-tooltip top>
                        <template v-slot:activator="{ on }">
                          <div class="caption" v-if="hack.position>0">
                            <v-icon :color="star_color[hack.position-1]" v-on="on">star</v-icon>
                          </div>
                        </template>
  ...
  data: () => ({
    ...
    hackathons: [
      ...
      },
      {
        ...
        date_end: "2019.05.12",
        text:
          "A standard university hosted hackathon. But with quite good prizes. Also a typical short duration of 24 hours.",
        cover: "none",
        city: "Karlsruhe",
        country: "Germany",
      ...
      },
      {
        ...
        date_end: "2019.05.15",
        text:
          "Hard core technical event! NEED to apply for a free ticket. Otherwise it is 350 EUR.",
      ...
      },
      {
        ...
        date_end: "2019.04.13",
        text:
          "Use of a raspberry pi to monitor quality of engament at lectures.",
        city: "Berlin",
        country: "Germany",
        position: 0,
        tags: [
      ...
      },
      {
        ...
        date_end: "2019.04.12",
        text:
          "Use of Social media to collect feedback about the quality of the ride.",
        city: "Menden",
        country: "Germany",
        position: 1,
        tags: [
      ...
      },
      {
        ...
        date_end: "2019.04.07",
        text:
          "Use of Blockchain for micro-payments and micro-credits in Africa.",
        city: "Essen",
        country: "Germany",
        position: 1,
      ...
      },
      {
        ...
        url: ["https://paxtechhack.bemyapp.com/"],
        pics: [
      ...
      },
      {
        ...
        pics: [],
        git: ["https://gitlab.com/kasper747/wirbuddeln"],
        url: ["https://www.facebook.com/events/283074352307152/"]
      },
      {
